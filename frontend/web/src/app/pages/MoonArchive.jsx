...
// Comprehensive mock data covering all systems over a longer period
const mockArchiveData = [
  {
    id: "ARCH-001",
    message: "Dr. Sarah Johnson submitted verification documents",
    timestamp: "2026-03-10T14:30:00Z",
    type: "Verification",
    status: "Pending",
    admin: "System",
    route: "/medical-verification",
  },
  {
    id: "ARCH-002",
    message: "Emma Williams flagged a community post",
  ...
  {
    id: "ARCH-003",
    message: "Published new article: Understanding Hormonal Changes",
  ...
  {
    id: "ARCH-004",
    message: "New user registration: Olivia Brown",
  ...
  {
    id: "ARCH-006",
    message: "Chatbot report resolved: Medical advice inquiry",
    timestamp: "2026-03-06T15:10:00Z",
    type: "Reports",
    status: "Inactive",
    admin: "Admin Staff",
    route: "/chatbot-reports",
  },
  {
    id: "ARCH-007",
    message: "Suspended user account: toxic_user_99",
  ...
  {
    id: "ARCH-008",
    message: "Global Push Notification sent: Scheduled Maintenance",
  ...
  {
    id: "ARCH-009",
    message: "Dr. James Lee's verification approved",
  ...
  },
  {
    ...
    type: "System",
    status: "Approved", // Using matching badges
    admin: "System Auto",
    route: "/system-info",
  },
];
